...
func TestConversation(ctx context.Context, req sitesync.TestConversationRequest) (*sitesync.TestConversationResult, error) {
	return sitesync.TestConversation(ctx, req)
}

func TestConversationStream(ctx context.Context, req sitesync.TestConversationRequest, emit sitesync.TestConversationStreamEmit) (*sitesync.TestConversationResult, error) {
	return sitesync.TestConversationStream(ctx, req, emit)
}
