...
func syncAccountState(ctx context.Context, siteRecord *model.Site, account *model.SiteAccount) (*syncSnapshot, error) {
	...
	case model.SitePlatformAPI, model.SitePlatformDeepSeek, model.SitePlatformClaude, model.SitePlatformNVIDIA, model.SitePlatformGrok:
...
func checkinAccountState(ctx context.Context, siteRecord *model.Site, account *model.SiteAccount) (*model.SiteCheckinResult, string, error) {
	...
	switch siteRecord.Platform {
	case model.SitePlatformDoneHub, model.SitePlatformSub2API, model.SitePlatformAPI, model.SitePlatformDeepSeek, model.SitePlatformClaude, model.SitePlatformNVIDIA, model.SitePlatformGrok:
...
func syncWithDirectToken(ctx context.Context, siteRecord *model.Site, account *model.SiteAccount, token string, source string) (*syncSnapshot, error) {
	...
	snapshot.balance, snapshot.balanceUsed, snapshot.todayIncome = fetchSiteAccountBalance(ctx, siteRecord, account, token, 0)
