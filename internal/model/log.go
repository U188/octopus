...
type RelayLog struct {
	...
	UpstreamRequestContent  string              `json:"upstream_request_content" gorm:"type:text"` // 实际发送到上游的请求内容
	UpstreamBaseURL         string              `json:"upstream_base_url" gorm:"type:text"`        // 实际选中的上游 base_url
	SystemPromptRetry       bool                `json:"system_prompt_retry" gorm:"not null;default:false"`
	SystemPromptRetryReason string              `json:"system_prompt_retry_reason" gorm:"type:varchar(32)"`
