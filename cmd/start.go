...
import (
	...
	"github.com/U188/octopus/internal/server"
	"github.com/U188/octopus/internal/task"
...
var startCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		telegramBotCtx, stopTelegramBot := context.WithCancel(context.Background())
		shutdown.Register(func() error {
			stopTelegramBot()
			return nil
		})
		safe.Go("telegram-bot", func() {
			tgbot.Run(telegramBotCtx)
		})
