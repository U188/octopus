...
function ModelPickerSection({
    ...
    return (
        <div className="rounded-xl border border-border/50 bg-muted/30 flex flex-col min-h-[70dvh] md:min-h-0">
...
export function GroupEditor({
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col h-full min-h-0">
            <div className="flex-1 min-h-0 overflow-y-auto px-1 md:overflow-hidden">
                <FieldGroup className="gap-4 flex flex-col min-h-full md:h-full md:min-h-0">
                    ...
                    <div className="md:flex-1 md:min-h-0">
                        <div className="grid grid-cols-1 gap-4 md:h-full md:min-h-0 md:grid-cols-2">
                            <ModelPickerSection
