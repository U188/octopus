...
export const SettingKey = {
    ...
    IPWhitelistEnabled: 'ip_whitelist_enabled',
    ...
    TelegramBotAdminIDs: 'telegram_bot_admin_ids',
    TelegramBotAPIBaseURL: 'telegram_bot_api_base_url',
    ...
    TelegramReportEnabled: 'telegram_report_enabled',
    TelegramReportTime: 'telegram_report_time',
    TelegramAlertEnabled: 'telegram_alert_enabled',
    TelegramAlertBalanceThreshold: 'telegram_alert_balance_threshold',
    TelegramAlertFailureRatePct: 'telegram_alert_failure_rate_pct',
